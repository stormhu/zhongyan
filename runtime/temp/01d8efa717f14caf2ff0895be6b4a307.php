<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"../template/default/peixun.html";i:1491899236;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="container" style="min-height:300px;">
	<div class="row">
		<div class="col-md-12 box1" style="min-height:300px; padding-bottom:50px;">
			<img class="hidden center-block" src="/template/default/image/peixun/icon1.png">
			<h3 class="hidden text-center">7年网络营销培训经验</h3>
		</div>
		<div class="col-md-12 box2" style="min-height:300px; padding-bottom:50px;">
			<img class="hidden center-block" src="/template/default/image/peixun/icon2.png">
			<h3 class="hidden text-center">超过20名自身网络营销专家</h3>
		</div>
		<div class="col-md-12 box3" style="min-height:300px; padding-bottom:50px;">
			<img class="hidden center-block" src="/template/default/image/peixun/icon3.png">
			<h3 class="hidden text-center">服务过420多个细分行业</h3>
		</div>
		<div class="col-md-12 box4" style="min-height:300px; padding-bottom:50px;">
			<img class="hidden center-block" src="/template/default/image/peixun/icon4.png">
			<h3 class="hidden text-center">陆续培训超过千家企业，为传统企业转型保驾护航！</h3>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	$win.scroll(function(){
		...
		if(!(winScrollTop > box2OffsetTop+box2OffsetHeight) && !(winScrollTop-temp<box2OffsetTop-winHeight) && !($(".box2").hasClass("done"))){
			...
			$(".box2").children("h3").removeClass("hidden");
			$(".box2").children("img").addClass("animated fadeInRight done");
			$(".box2").children("h3").addClass("animated fadeInRight done");
		}
		// box2
		if(!(winScrollTop > box3OffsetTop+box3OffsetHeight) && !(winScrollTop-temp<box3OffsetTop-winHeight) && !($(".box3").hasClass("done"))){
			...
			$(".box3").children("h3").removeClass("hidden");
			$(".box3").children("img").addClass("animated fadeInLeft done");
			$(".box3").children("h3").addClass("animated fadeInLeft done");
		}
		// box2
		if(!(winScrollTop > box4OffsetTop+box4OffsetHeight) && !(winScrollTop-temp<box4OffsetTop-winHeight) && !($(".box4").hasClass("done"))){
			...
			$(".box4").children("h3").removeClass("hidden");
			$(".box4").children("img").addClass("animated fadeInRight done");
			$(".box4").children("h3").addClass("animated fadeInRight done");
		}
	});
</script>
